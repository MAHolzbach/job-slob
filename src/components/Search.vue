<template>
  <div class="w-full max-w-xs">
    ...
    <form class="shadow-lg rounded px-8 pt-6 pb-8 mb-6 border">
      <div class="mb-4">
        <label class="block text-darkGray text-lg mb-2 pl-1" for="what">What</label>
        <input
      ...
      <div class="mb-6">
        <label class="block text-darkGray text-lg mb-2 pl-1" for="where">Where</label>
        <input
...
<script>
  ...
  export default {
    ...
    computed: mapState(["totalJobNumber", "recentSearches"]),
  };
</script>
